Contributing to IKT Core
============================

The IKT Core project operates an open contributor model where anyone is
...
The following applies to code changes to the IKT Core project, and is not to be
confused with overall IKT Network Protocol consensus changes.

Whether a pull request is merged into IKT Core rests with the project merge
...
Patches that change IKT consensus rules are considerably more involved than
...
Where a patch set proposes to change the IKT consensus, it must have been
...
The project leader is the release manager for each IKT Core release.
