...
This mechanism has been integrated into Bitcore-Node-IKT which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/IKT-Project/insight-api-innoket#web-socket-api](https://github.com/IKT-Project/insight-api-innoket#web-socket-api) 
* API: [https://github.com/IKT-Project/insight-api-innoket#swifttx-transactions](https://github.com/IKT-Project/insight-api-innoket#swifttx-transactions) 
...
By default, the IKT Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the IKT Core daemon:
