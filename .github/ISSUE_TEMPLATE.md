...
This issue tracker is only for technical issues related to IKT Core.
General IKT questions and/or support requests and are best directed to the [IKT Discord](https://discord.innoket.org).
...
### What version of IKT Core are you using?
