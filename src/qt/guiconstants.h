...
/* Innoket GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "IKT"
#define QAPP_ORG_DOMAIN "innoket.org"
#define QAPP_APP_NAME_DEFAULT "IKT-Qt"
#define QAPP_APP_NAME_TESTNET "IKT-Qt-testnet"
