...
/** Utility functions used by the IKT Qt UI.
 */
namespace GUIUtil
{
...
// Render IKT addresses in monospace font
...
// Parse "innoket:" URI into recipient object, return true on successful parsing
