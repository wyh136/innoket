                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("IKT Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a IKT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and innoket: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About IKT Core"), this);
    aboutAction->setStatusTip(tr("Show information about IKT Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for IKT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your IKT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified IKT addresses"));
    ...
    openAction->setStatusTip(tr("Open a IKT: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the IKT Core help message to get a list with possible IKT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("IKT Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to IKT network", "", count));
}
...
{
    QString strTitle = tr("IKT Core"); // default title
