...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* IKT features */
        {"innoket", "masternode", &masternode, true, true, false},
        {"innoket", "listmasternodes", &listmasternodes, true, true, false},
        {"innoket", "getmasternodecount", &getmasternodecount, true, true, false},
        {"innoket", "masternodeconnect", &masternodeconnect, true, true, false},
        {"innoket", "masternodecurrent", &masternodecurrent, true, true, false},
        {"innoket", "masternodedebug", &masternodedebug, true, true, false},
        {"innoket", "startmasternode", &startmasternode, true, true, false},
        {"innoket", "createmasternodekey", &createmasternodekey, true, true, false},
        {"innoket", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"innoket", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"innoket", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"innoket", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"innoket", "getmasternodescores", &getmasternodescores, true, true, false},
        {"innoket", "mnbudget", &mnbudget, true, true, false},
        {"innoket", "preparebudget", &preparebudget, true, true, false},
        {"innoket", "submitbudget", &submitbudget, true, true, false},
        {"innoket", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"innoket", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"innoket", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"innoket", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"innoket", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"innoket", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"innoket", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"innoket", "checkbudgets", &checkbudgets, true, true, false},
        {"innoket", "mnsync", &mnsync, true, true, false},
        {"innoket", "spork", &spork, true, true, false},
        {"innoket", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"innoket", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> innoket-cli " + methodname + " " + args + "\n";
}
