...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Innoket Core innoket-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  innoket-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded innoket transaction") + "\n" +
                               "  innoket-tx [options] -create [commands]   " + _("Create hex-encoded innoket transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded innoket transaction
